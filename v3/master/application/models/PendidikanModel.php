...
class PendidikanModel extends CI_Model {
	...
	{
		$sql = "SELECT rp.*, jp.* FROM riwayat_pendidikan rp JOIN jenjang_pendidikan jp ON rp.id_jenjang_pendidikan = jp.id_jenjang_pendidikan WHERE rp.id_dosen = '".$data['nip']."' ORDER BY rp.tmt desc";
