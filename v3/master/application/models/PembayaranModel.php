...
public function getPembayaranPerBulanTahun($data)
	...
	{
		$sql = "INSERT INTO pembayaran VALUES ('','".$data['idBendahara']."','".$data['nip']."','".$data['tgl_bayar']."', '".$data['bulan']."','".$data['tahun']."', '".$data['sksr_gaji']."', '".$data['sksr_kinerja']."', '".$data['tarif_gaji']."','".$data['tarif_kinerja']."', '1')";
		$res = $this->db->query($sql);
