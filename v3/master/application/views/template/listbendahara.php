            ...
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Daftar Bendahara</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                                ...
                                <div class="ibox-title">
                                    ...
                                    <div class="ibox-tools">
                                        ...
                                        <div class="form-group" id="data_4">
                                            ...
                                            <div class="col-md-3">
                                                <button type="submit" class="btn btn-info btnsubmit" onclick="getBendahara();" id="btn-submit" ><span class="fa fa-search"></span>Tampilkan</button>
                                                </form>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Edit Data Bendahara</h4>
                                            <small>Edit Data Individu Bendahara</small>
                                        ...
                                        <div class="modal-body">                                             
                                            ...
                                            <div class="form-group">
                                                <label class='control-label' for='nama'>Nama</label><input id='nama-edit' class='form-control' name="nama_bendahara">
                                            </div>                                            
                                            <div class="form-group">
                                            ...
                                            <input type="hidden" id="bendahara-edit" name="id_bendahara">                                     
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Hapus Data Bendahara</h4>
                                            <small>Konfirmasi Hapus Data Individu Bendahara</small>
                                        ...
                                        <div class="modal-body">                                             
                                            ...
                                            <input type='hidden' id='bendahara-hapus' name='id_bendahara'>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Reset Password Bendahara</h4>
                                            <small>Konfirmasi Reset Password Individu Bendahara</small>
                                        ...
                                        <div class="modal-body">                                             
                                            ...
                                            <input type='hidden' id='idBendaharaReset' name='id_bendahara'>
...
var t = $("#datatable").DataTable();
    ...
    function getBendahara()
    {
        ...
        $.ajax(
        {
           url: "<?php echo base_url();?>index.php/Bendahara/getDataBendahara",
           type: "GET",
           data : postData,                   
           success: function (ajaxData)
           {
                ...
                {
                    var button1 = "<a href='#' class='btn-edit' data-did='"+result[i]['id_bendahara']+"' title='Edit'><span class='fa fa-edit fa-2x'></span></a>";
                    var button2 = "<a href='#' class='btn-hapus' data-did='"+result[i]['id_bendahara']+"' title='Hapus'><span class='fa fa-trash fa-2x'></span></a>";
                    var button3 = "<a href='#' class='btn-reset-pass' data-did='"+result[i]['id_bendahara']+"' title='Reset Password'><span class='fa fa-user fa-2x'></span></a>";
                     t.row.add( [
                            i+1,
                            result[i]['id_user'],
                            result[i]['nama'],
    ...
    $('#datatable').on('click', '.btn-edit', function(){
        ...
        $.ajax(
        {
            url:"<?php echo base_url();?>index.php/Bendahara/getDataBendaharaIndividu",
            type:"GET",
            data : {id_bendahara:n},
            success: function (ajaxData)
           {
                ...
                $("#bendahara-edit").val(result[0]['id_bendahara']);
    ...
    $('#btn-update').click(function(){
        ...
        $('#editModal').modal('hide');
                var updateData = $("#formEdit").serialize();
                  ...
                  $.ajax({
                    url : "<?php echo base_url();?>index.php/Bendahara/updateDataBendaharaIndividu",
                    type: "POST",
                    data : updateData,
                    ...
                    getBendahara();
                     $.notify({
                            title: "<strong>Update Data Bendahara </strong> ",
                            message: "Success"              
                        },
                        {
                            type : 'success',
...
<script>
   ...
   $("#btn-delete").click(function(){
      ...
      $.ajax({
        url : "<?php echo base_url();?>index.php/Bendahara/deleteDataBendaharaIndividu",
        type: "POST",
        data : deleteData,
        success: function(data,status, xhr)
        {
         ...
         getDosen();
         $.notify({
                title: "<strong>Hapus Data Bendahara: </strong> ",
                message: data              
            },
            {
                type : 'success',
    ...
    $("#btn-reset").click(function(){
      ...
      $.ajax({
        url : "<?php echo base_url();?>index.php/Bendahara/resetPassBendahara",
        type: "POST",
        data : resetData,
        success: function(data,status, xhr)
        {
