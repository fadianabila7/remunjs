                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <th>Total SKS (A)</th>
                                        <th>Σ Kelebihan SKS (B)</th>
                                        <th>Σ Kelebihan SKS dapat dibayar (C)</th>
                                        <th>Σ Sisa Kelebihan SKS dapat dibayar (D)</th>
                    ...
                    for(var i=0; i<result.length; i++)
                    {
                        ...
                        if(textbulan!=null)
                        {
                             t.row.add( [
                                    i+1,
                                    textbulan,
                                    "<a href='#' data-toggle='tooltip' data-placement='Right' title='SKS Wajib "+textbulan+" = "+result[i]['wajibsks']+", Kelebihan Maks "+textbulan+" = "+result[i]['lebihsksmaks']+"'>"+result[i]['struktural']+"</a>",
                                    result[i]['totalsks'],
                                    result[i]['lebihsks'],
                                    result[i]['lebihsksbayar'],
                                    result[i]['sisasksbayar']
