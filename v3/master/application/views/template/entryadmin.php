                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url();?>index.php/Admin/entryDataAdmin">
                                        ...
                                        <div class="form-group">
                                        <label for="namadosen" class="col-md-3 control-label">Nama Admin *</label>
                                        <div class="col-md-6">
