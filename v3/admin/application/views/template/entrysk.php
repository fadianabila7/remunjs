                                    ...
                                    <form class="form-horizontal" id="formEntry" enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>index.php/Penunjang/submitDataSK">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-3">
                                                ...
                                                <input type="hidden" class="form-control col-md-0" id="keg_bln" name="keg_bln" required>
                                            </div>
                                        </div>
...
<script language="javascript">
    ...
    function tambahDosen() 
    {
        ...
        coloumn3 = '<input type="text" id="nip'+idxrow+'" class="form-control m-b" name="nip[]" value="" readonly required>';
