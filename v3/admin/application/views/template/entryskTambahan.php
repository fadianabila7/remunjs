        ...
        <div id="page-content">
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    <h2>Entry Surat Keputusan Tugas Tambahan Non Struktural</h2>
                    <ol class="breadcrumb">
                        <li>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal" id="formEntry" enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>index.php/Tambahan/submitDataSK">
                                    
                                    <div class="form-group">
                                        <label for="sk" class="col-md-3 control-label">No SK *</label>
                                        <div class="input-group col-md-6">
                                            <input class="form-control" type="text" name="sk" minlength="8" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="tmtdate">
                                        ...
                                        <div class="input-group date col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="tgl_sk" name="tgl_sk" required
                                            pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
                                            placeholder="yyyy-mm-dd">
                                        </div>
                                        <label class="control-label col-md-5" style="font-size: 12px;"><i>format date : <code>yyyy-mm-dd</code></i></label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="nama_keg" class="col-md-3 control-label">Jumlah Kegiatan *</label>
                                        <div class="input-group col-md-3">
                                            <input type="number" min='1' class="form-control" id="jml_keg" name="jml_keg" required>
                                            <span class="input-group-addon" id="ketSatuan">-</span>
                                            <input type="hidden" class="form-control" id="keg_bln" name="keg_bln" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="tmtdate2">
                                        ...
                                        <div class="input-group date col-md-6">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" class="form-control" id="tgl_keg" name="tgl_keg" required
                                            pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
                                            placeholder="yyyy-mm-dd">
                                        </div>
                                        <label class="control-label col-md-5" style="font-size: 12px;"><i>format date : <code>yyyy-mm-dd</code></i></label>
        ...
        $.ajax({
            ...
            success: function(ajaxData)
            {
                ...
                if(kegiatan[0]['bobot_sks']==null)
                {
                    ...
                    $('#ketSatuan').html(kegiatan[0]['satuan']);
                    $('#keg_bln').val(kegiatan[0]['keg_bulanan']);
                    //reloadJSkegiatan();                         
                }
                else 
                {
...
//    function reloadJSkegiatan()
 ...
 /*   $('#abc1').change(function(){
    ...
    var n=0;
            ...
            $.ajax(
        {
           url: "<?php echo base_url();?>index.php/Dosen/getDataDosenAll",
           type: "POST",
           data : {nip: n},                   
           success: function (ajaxData)
           {
