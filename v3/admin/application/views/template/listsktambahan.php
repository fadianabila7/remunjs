...
<div id="page-content">
    <div class="row wrapper border-bottom white-bg dashboard-header">
        <div class="col-lg-10">
            <h2>List Surat Keputusan Tugas Tambahan Non Struktural</h2>
            <ol class="breadcrumb">
                <li>
            ...
            <div class="modal-dialog" style="width: 900px">
                <div class="modal-content animated fadeIn">
                    ...
                    <div class="modal-body">                                             
                        ...
                        <!-- <div class="form-group">
                            <label for="tgl_sk" class="col-md-3 control-label">Tanggal Surat Keputusan</label>
                            <div class="col-md-6">
            ...
            <div class="modal-dialog">
                <div class="modal-content animated fadeIn">
                    ...
                    <div class="modal-body">                                             
                        ...
                        <input type='text' id='id_kegiatan_dosen' name='id_kegiatan_dosen'>
...
var postData = $('#formTampil').serialize();
    ...
    function getDataSKBulanTahun()
    {
        ...
        //var postData = $('#demo-form2').serialize();
            ...
            submitHandler: function(form) {
                ...
                $.ajax(
            {
               url: "<?php echo base_url();?>index.php/Tambahan/getDataSKBulanTahun",
               type: "GET",
               data : postData,                   
               success: function (ajaxData)
               {
                    ...
                    {  
                        ...
                        buttondelete = '<button class="btn btn-danger btn-delete" data-nosk = "'+result[i]['uuid']+'" disabled><span class="fa fa-trash"></span></button>';
    ...
    {        
        ...
        $.ajax(
        {
               url: "<?php echo base_url();?>index.php/Tambahan/getDataKegiatanByNoSK",
               type: "GET",
               data : {no_sk:noSK},                   
               success: function (ajaxData)
               {    
                    ...
                    $('#tgl_keg_modal').val(result[0]['tgl_keg']);
                        ...
                        {  
                            ...
                            kode = "<a href='#'>"+result[i]['nama_keg']+" :: "+result[i]['kode_keg']+"</a>";
                            inputNip = '<input type="hidden" id="nip'+i+'" name = "nip[]" value="'+result[i]['nip']+'">';
                            console.log(i+","+result[i]['nama_dosen']);
                            tabelModal.row.add( [
                                    i+1,                                
                                    result[i]['nama_dosen']+'<br><u>'+
                                    result[i]['nip']+inputNip+'</u>',
                                    result[i]['tgl_keg'],
                                    kode+'<br>Deskripsi : '+result[i]['judul_keg'],
                                    buttondetail                                
                                ] ).draw();
    ...
    $('#datatable').on('click','.btn-upload',function(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>index.php/Tambahan/getBerkasSK",
            type: "GET",
            data : {no_sk:noSK},
            success: function (ajaxData)
            { 
                $('#formUpload').attr('action','<?php echo base_url();?>index.php/Tambahan/uploadBerkasSK');
    ...
    function updateSK()
    {
        ...
        $('#formEdit').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax(
                {
                   url: "<?php echo base_url();?>index.php/Tambahan/updateDataSK",
                   type: "POST",
                   data : postData,                   
                   success: function (ajaxData)
                   {
    ...
    function deleteSK()
    {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url();?>index.php/Tambahan/deleteDataSK",
            type: "POST",
            data : deleteData,                   
            success: function (ajaxData)
            {
                $.notify({
                    title: "<strong>Delete Data Surat Keputusan</strong> "+ajaxData,
                    message: "Success"              
                },
                {
                    type : 'success',
            ...
            {
                $.notify({
                    title: "<strong>Delete Data Surat Keputusan</strong> "+status,
                    message: "Failed"              
                },
                {
                    type : 'danger',
    ...
    function uploadBerkas()
    {
        ...
        $('#formUpload').validate({
            submitHandler: function(form)
            {
               ...
               /* var uploadData = $(form).serialize();


                $.ajax({
                    url: "<?php echo base_url();?>index.php/MainControler/uploadBerkasSK",
                    type: "POST",
                    data : uploadData,                   
                    success: function (ajaxData)
                    {
                        $('#uploadModal').modal('hide');
                        $.notify({
                            title: "<strong>Upload Berkas Surat Keputusan</strong> "+ajaxData,
                            message: "Success"              
                        },
                        {
                            type : 'success',
