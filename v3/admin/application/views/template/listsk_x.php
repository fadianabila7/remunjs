            ...
            <div class="modal-dialog" style="width: 900px">
                <div class="modal-content animated fadeIn">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id='btn-update' onclick="updateSK();" class="btn btn-primary">Save changes</button>
                    </div>
                    </form>
                </div>
            </div>
                ...
                $.ajax(
            {
               ...
               success: function (ajaxData)
               {
                    ...
                    {  
                        ...
                        buttondelete = '<button class="btn btn-danger btn-delete" data-nosk = "'+result[i]['id_kegiatan_dosen']+'"><span class="fa fa-trash"></span></button>';
