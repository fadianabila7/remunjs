        ...
        <div id="page-content">
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Entry Penelitian Dosen</strong>
                        </li>
                    </ol>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                               ...
                               <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <?php 
                                    $no=1;
                                    foreach ($data['dataPenelitian'] as $d) {
                            ...
                            <ul class='dropdown-menu'>
                                ...
                                <li><a href='";
                                echo site_url("penelitian/do_deletePenelitian/".$d['id_kegiatan_dosen']);
                                echo "'>Hapus</a></li>
                          ...
                          <button id="tambahBK" type="button" class="btn btn-success" data-toggle='modal' data-target='#myModal'>Tambah Penelitian Dosen</button>
                      </div>
                        <br>
                        <br> 
            ...
            <script type="text/javascript">
              <?php
                foreach ($data['dataPenelitian'] as $dosen) {
         ...
         <script type="text/javascript">
            ...
            $('#nama_dosenubah').autoComplete({
             ...
             <?php
                 $linkInsert = site_url('penelitian/do_insertPenelitian');
            ...
            swal({
              ...
              location.reload();
                 ...
                 ?>   
                  ...
                  <?php
                 $linkUbah = site_url('penelitian/do_ubahPenelitian');
