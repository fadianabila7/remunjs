                    ...
                    if(array[i].status_kegiatan<0){ 
                        button = "<center>"+
                                    "<div class='btn-group'>"+
                                        ...
                                        "<ul class='dropdown-menu' style='margin-left:-81px;'>"+
                                            "<li><a href='#' disable class='buttonUbah' data-idx='"+array[i].id_kegiatan_dosen+"#"+deskripsi.uuid_bimbing+"' id='id"+array[i].id_kegiatan_dosen+"'>Ubah</a></li>"+
                                            "<li><a href='<?php echo site_url("pengajaran/do_deletekegiatandosenMembimbing/"); ?>"+array[i].id_kegiatan_dosen+"-"+deskripsi.uuid_bimbing+"'>Hapus</a></li>"+
                                        "</ul>"+
                                    "</div>"+
                                "</center>";
                    }else{
                        button = '<center><button class="btn btn-danger tx-'+array[i].id_kegiatan_dosen+'"><i class="fa fa-exclamation-circle"></i></button></center>';
                    }
