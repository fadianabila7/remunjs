...
<div id="page-content">
    <div class="row wrapper border-bottom white-bg dashboard-header">
        <div class="col-lg-10">
            <h2>Entry Kegiatan</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="<?php echo site_url(); ?>">Home</a>
                </li>
                <li class="active">
                    <strong>Entry Penelitian</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url(); ?>index.php/penelitian/SubmitDataMandiri">
                            <div class="form-group">
                                <label for="sk" class="col-md-3 control-label">Judul Penelitian/Pengabdian *</label>
                                <div class="input-group col-md-6">
                                    <input class="form-control" type="text" name="judul_penelitian" minlength="8" required>
                                </div>
                            </div>
                            <!-- 
                                    <div class="form-group">
                                    <label for="sk" class="col-md-3 control-label">Penerbit *</label>
                                    <div class="input-group col-md-6">
                            ...
                            <div class="form-group" id="tmtdate">
                                ...
                                <div class="input-group date col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="tgl_mulai" name="tgl_mulai" placeholder="Tanggal Mulai" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" required>
                                </div>
                                <label class="col-md-3"> </label>
                                <label class="col-md-6">format:<code>yyyy-mm-dd</code></label>
                            </div>

                            <div class="form-group" id="tmtdate">
                                <label class="control-label col-md-3">Lama Kegiatan *</label>
                                <div class="input-group col-md-3">
                                    <input type="number" class="form-control" id="jml_bulan" name="jml_bulan" value="1" max='12' required>
                            ...
                            <div class="form-group">
                                <label for="nama_keg" class="col-md-3 control-label">No SK </label>
                                <div class="input-group col-md-6">
                                    <input class="form-control" type="text" name="sk" minlength="8">
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="tmtdate">
                                ...
                                <div class="input-group date col-md-3">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    <input type="text" class="form-control" id="tgl_sk" name="tgl_sk" placeholder="Tanggal SK" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" required>
                                </div>
                                <label class="col-md-3"> </label>
                                <label class="col-md-6">format:<code>yyyy-mm-dd</code></label>
                            </div>
...
<script language="javascript">
    ...
    var listf = <?php echo json_encode($data['datasession']); ?>;
    for (var i = listf.length; i >= 0; i--) {
        console.log(listf[i]['idFakultas']);
    }
    ...
    function reloadJSauto() {
        ...
        $('#datatable .dosen-auto').autoComplete({
            minChars: 1,
    ...
    $('#table-body').on('click', '.dosen-auto', function() {
    ...
    function tambahDosen() {
        ...
        var coloumn5;
        var opt = "";
        var list = <?php echo json_encode($data['kegiatan']); ?>;
        ...
        coloumn3 = '<input type="text" id="nip' + idxrow + '" class="form-control m-b" name="nip[]" readonly required>';
    ...
    function hapusElemen(idx) {
        //document.getElementById('idf').value = document.getElementById('idf').value - 1;
        //document.getElementsByName("alltotal")[0].setAttribute("value", alltotal);
        $(idx).html('');
        i--;
        document.getElementById('idf').value = i;

        var alltotal = 0;
        var T = document.getElementsByName('total_harga[]');
        for (key = 0; key < T.length; key++) {
            if (T[key].value == "") {
                alltotal = alltotal + 0;
            } else {
                alltotal = alltotal + parseInt(T[key].value.replace(/\./g, ""));
            }
        }
        document.getElementsByName("alltotal")[0].setAttribute("value", toRp(alltotal.toString()));
    }
    ...
    function getKegiatanTurunan(kode_induk) {
        ...
        var opt = "";
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/penelitian/getKegiatanByInduk",
            type: "GET",
            data: {
                kode: kode_induk
            },
...
<script>
    ...
    var n = 0;
    $.ajax({
        url: "//remunerasi.unri.ac.id/v3/Operator/index.php/pengajaran/json_search_dosen",
        type: "POST",
        data: {
            nip: n
        },
