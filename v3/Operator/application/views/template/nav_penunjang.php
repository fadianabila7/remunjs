<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li id="home">
                        <a href="<?php echo site_url('penunjang');?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span> </a>                        
                    </li>
                   
                    <li>
                        <a href="<?php echo site_url('penunjang/EntryPenunjangDosen');?>"><i class="fa fa-edit"></i> <span class="nav-label">Entry Penunjang Dosen</span> </a>                        
                    </li>
