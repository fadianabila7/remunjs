                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Entry Pengabdian Kepada Masyarakat</h5>
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url();?>index.php/pengabdian/submitDataPengabdian">
                                       ...
                                       <!--  <div class="form-group">
                                            <label for="skema_penelitian" class="col-md-3 control-label">Skema Pengabdian *</label>
                                            <div class="input-group col-md-6">
 ...
 -->
                                        <div class="form-group">
                                        <label for="nosk" class="col-md-3 control-label">No SK </label>
                                        <div class="input-group col-md-6">
