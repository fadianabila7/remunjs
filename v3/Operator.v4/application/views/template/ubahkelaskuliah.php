                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content" id="sini">
                                <?php foreach ($data['dataKelasKuliah'] as $key) {
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal form-label-left" method="POST" action="<?php echo site_url($link) ?>">
                                                ...
                                                <select autofocus class="select2_single form-control" tabindex="-1" name="kegiatan" id="kegiatan">
                                                    ...
                                                    foreach ($data['dataKegiatan'] as $keya) {
                                                        if ($jenjangPendidikan == 0 or $jenjangPendidikan == 1 or $jenjangPendidikan == 8 || $jenjangPendidikan == 10 || $jenjangPendidikan == 11) {
                                                            if ($keya['kode_kegiatan'] == 2 or $keya['kode_kegiatan'] == 6 or $keya['kode_kegiatan'] == 7 or $keya['kode_kegiatan'] == 8 or $keya['kode_kegiatan'] == 9 or $keya['kode_kegiatan'] == 11) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control" tabindex="-1" name="semester" id="semester">
                                                    <option value="<?php echo $key['semester']; ?>"><?php if ($key['semester'] == "1") echo "Ganjil";
                                                                                                    else if ($key['semester'] == "2") echo "Genap";
                                                                                                    else echo "Antara"; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                <input id="sks" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-words="1" name="sks" placeholder="SKS" required="required" type="number" value="<?php echo $key['sks'] ?>" onkeyup="FunctionChekSKS()">
                                            </div>
                                        </div>
