            ...
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Menajadi Penyuluh Penata Pelatih</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Entry Menjadi Penyuluh Penata Pelatih</h5>
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url();?>index.php/pengabdian/submitDataPenyuluh">

                                        <div class="form-group">
                                        <label for="sk" class="col-md-3 control-label">Nama Kegiatan *</label>
                                        ...
                                        <div class="form-group" id="tmtdate">
                                                ...
                                                <div class="input-group date col-md-6">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" id="tgl_keg" name="tgl_keg" placeholder="Tanggal Terbit" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="input-group col-md-6">
                                            <input class="form-control" type="text" name="nama_keg">
                                        </div>
                                        </div>
       ...
       $('#datatable .dosen-auto').autoComplete({
            ...
            onSelect: function(event,ui){
                 ...
                 for (k=0;k<datajsondosen.length;k++)
                    if (datajsondosen[k].nama==ui) idDosen=datajsondosen[k].id_dosen;

                
            }
            });

           $('#table-body').on('change','.dosen-auto', function(){
    ...
    function tambahDosen() 
    {
       ...
       var list = <?php echo json_encode($data['kegiatan']); ?>;
        ...
        if(idxrow==1)
            ...
            coloumn5 = '<button class="btn btn-danger" onclick="deleteitem();"><span class="fa fa-trash"></span></button>';
  ...
  function getKegiatanTurunan(kode_induk)
    {
        ...
        var opt="";
        $.ajax({
            url: "<?php echo base_url();?>index.php/pengabdian/getKegiatanByInduk",
            type: "GET",
