                            ...
                            <div class="ibox-content">
                                <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url();?>index.php/penelitian/SubmitDataMandiri">
                                    ...
                                    <div class="form-group" id="tmtdate">
                                        ...
                                        <div class="input-group date col-md-3">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" class="form-control" id="tgl_sk" name="tgl_sk" placeholder="Tanggal SK"
                                            pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" required>
                                        </div>
                                        <label class="col-md-3"> </label>
                                        <label class="col-md-6">format:<code>yyyy-mm-dd</code></label> 
...
<script>
    ...
    var n=0;
    $.ajax({
        url: "<?php echo base_url();?>index.php/penelitian/getDataDosenByFakultas",
        type: "POST",
        data : {nip: n},                   
        success: function (ajaxData){datajsondosen = JSON.parse(ajaxData);},
        error: function(status){}
    });    
</script> 