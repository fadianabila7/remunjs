            ...
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Entry Penelitian APBN/PNBP</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Entry Penelitian APBN/PNBP</h5>
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal" id="formEntry" method="POST" action="<?php echo base_url();?>index.php/penelitian/SubmitDataAPBN">

                                        <div class="form-group">
                                        <label for="sk" class="col-md-3 control-label">Judul Penelitian *</label>
...
<!-- 
                                        ...
                                        <div class="form-group" id="tmtdate">
                                                ...
                                                <div class="input-group date col-md-6">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" id="tgl_mulai" name="tgl_mulai" placeholder="Tanggal Mulai" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="skema_penelitian" class="col-md-3 control-label">Skema Penelitian *</label>
                                            <div class="input-group col-md-6">
                                                <select class="form-control" type="text" id = "skema_penelitian" name="skema_penelitian" required>
 ...
 $('#table-body').on('click','.dosen-auto',function(){
    ...
    function tambahDosen() 
    {
       ...
       var list = <?php echo json_encode($data['kegiatan']); ?>;
        ...
        coloumn3 = '<input type="text" id="nip'+idxrow+'" class="form-control m-b" name="nip[]" readonly>';
