        ...
        <div id="page-content">
            <div class="row wrapper border-bottom white-bg dashboard-header">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo site_url('pengabdian');?>">Pengabdian</a>
                        </li>
                        <li class="active">
                            <strong>Entry Kegiatan Pengabdian Dosen</strong>
                        </li>
                    </ol>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                               ...
                               <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <?php 
                                    $no=1;
                                    foreach ($data['dataPengabdian'] as $d) {
                            ...
                            <ul class='dropdown-menu'>
                                ...
                                <li><a href='";
                                echo site_url("pengabdian/do_deletePengabdian/".$d['id_kegiatan_dosen']);
                                echo "'>Hapus</a></li>
                          ...
                          <button id="tambahBK" type="button" class="btn btn-success" data-toggle='modal' data-target='#myModal'>Tambah Kegiatan Pengabdian Dosen</button>
                      </div>
                        <br>
                        <br> 
            ...
            <script type="text/javascript">
              <?php
                foreach ($data['dataPengabdian'] as $dosen) {
         ...
         <script type="text/javascript">
            ...
            $('#nama_dosenubah').autoComplete({
             ...
             <?php
                 $linkInsert = site_url('pengabdian/do_insertPengabdian');
            ...
            swal({
              ...
              location.reload();
                 ...
                 ?>   
                  ...
                  <?php
                 $linkUbah = site_url('pengabdian/do_ubahPengabdian');
