...
<head>
    ...
    <link href="<?php echo base_url('assets');?>/css/plugins/jquery-autocomplete/jquery.auto-complete.css" rel="stylesheet">
    ...
    <script src="<?php echo base_url('assets');?>/js/plugins/numeral/numeral.min.js"></script>

    
    <script src="<?php echo base_url('assets');?>/js/plugins/jquery-autocomplete/jquery.auto-complete.js"></script>
