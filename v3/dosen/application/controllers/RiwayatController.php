		...
		if($this->session->userdata('sess_dosen'))
   		{
			...
			$this->template->view('template/riwayatgolongan',$data,$dataisi);
		}
		else
		{
		...
		if($this->session->userdata('sess_dosen'))
   		{
			...
			$this->template->view('template/riwayatpendidikan',$data,$dataisi);
		}
		else
		{
			redirect('VerifyLogin','refresh');
		...
		if($this->session->userdata('sess_dosen'))
   		{
			...
			$this->template->view('template/riwayatfungsional',$data,$dataisi);
		}
		else
		{
			redirect('VerifyLogin','refresh');
		...
		if($this->session->userdata('sess_dosen'))
   		{
			...
			$this->template->view('template/riwayatstruktural',$data,$dataisi);
		}
		else
		{
			redirect('VerifyLogin','refresh');
