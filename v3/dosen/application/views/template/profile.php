...
<script type="text/javascript">  
    function ubahPassword(){
        ...
        if(baru!=konfirm || baru==''){
            sweetAlert("Oops...", "Pasword tidak sama.", "error");
        }else{
            ...
            $.ajax(
            {
               ...
               success: function (ajaxData){
                    swal({title: 'Perubahan Password Berhasil',text: '',type: 'success'});
                    if(ajaxData==1){setTimeout(function() {location.reload();}, 2000);}       
                },
                error: function(status){
                    swal({title: 'Perubahan Password Gagal',text: '',type: 'danger'});
                }
            });
        }
    }
